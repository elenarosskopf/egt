...
explain spatial structure and subsequent change in behaviour

%------------------------------------------------

\subsection*{Hawk Dove}

problem with the reverse P, S payoffs and possibilities here
explain difference to PD
explain pay-off matrix
